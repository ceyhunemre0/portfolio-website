      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            ...
            >
              <div className={clsx("h-60 flex items-center justify-center", `bg-${project.color}-100`)}>
                {project.icon}
              </div>
              <div className="p-6">
                <span className={clsx("text-xs font-semibold uppercase tracking-wider", `text-${project.color}-600`)}>
                  {project.category}
                </span>
                    ...
                    <span
                      ...
                      className={clsx(
                        "px-3 py-1 text-xs rounded-full",
                         `bg-${project.color}-100 text-${project.color}-600`
                      )}
                    >
                      {tag}
                    </span>
                ...
                <a
                  href="#"
                  className={clsx(
                    "inline-block font-medium transition duration-300",
                    `text-${project.color}-600 hover:text-${project.color}-800`
                  )}
                >
